"""CodexProvider — adapter boundary, NOT implemented.
...
When implemented, the adapter's responsibilities will be:
  ...
  - call the Codex API, reading credentials from environment variables only
...
NOT_CONFIGURED_MESSAGE = (
    "the Codex provider is not configured in this deployment; no interpretation "
    "was attempted"
)


class CodexProvider:
    """Placeholder adapter for the Codex model provider."""
